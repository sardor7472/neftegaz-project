                        ...
                        <v-card>
                            ...
                            <v-card-text>
                                ...
                                <div class="">
                                    ...
                                    <v-text-field
                                        ...
                                        <template v-slot:append>
                                            <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1"
                                                 enable-background="new 0 0 515.558 515.558" height="20"
                                    ...
                                    <vue-custom-scrollbar class="scroll-area pr-4" :settings="settings"
                                    ...
                                    <v-col>
                                            <span class="mr-2">
                                                <svg height="12" width="12" xmlns="http://www.w3.org/2000/svg"
                                                     ...
                                                     id="Layer_1" x="0px" y="0px" viewBox="0 0 600.1 800"
                                                     enable-background="new 0 0 600.1 800" xml:space="preserve">
                                                        <path fill="#00A5E2"
