<template xmlns:v-slot="v-slo//www.w3.org/1999/XSL/Transform">
	...
	<path d="M27.961,99.367c-5.8,5.8-5.7,15.3,0.5,20.899c5.8,5.301,14.8,4.801,20.3-0.8l47.3-47.3c2.8-2.8,4.2-6.5,4.2-10.2
		...
		L27.961,99.367z"></path>
                ...
                <div class="mt-12   ">
                    <div>
                        <soan class="link-color">Punkt raqami:</soan> 1. ПРИКАЗ - №13 от 13.01.2020г. - О дополнительных мерах по бесперебойному обеспечению
                        потребителей нефтепродуктами
                    </div>
                    <div class="mt-44">
                        <span class="link-color">Turi:</span> На исполнение
                    </div>
                    <div class="mt-11">
                        <span class="link-color">Bajarilish muddati:</span> 20 янв 2020
                    </div>
                    <div class="mt-11">
                        <span class="link-color">Yuboruvchilar:</span>
                        <ul>
                            <li>1.АО Узлитинефтгаз</li>
                            <li>2.Узбекская военизированная часть по предпреждению и ликвидации открытых нефтяных и газовых фонтанов УзВЧ</li>
                            <li>3.АО Узбекгеофизика</li>
                            <li>4.ООО Нефтгазмейор</li>
                            <li>5.Бухарский нефтегазовый промышленный колледж</li>
                            <li>6.Филиал Российского государственного университета нефти и газа им.Губкина</li>
                            <li><span class="link-color">7.АО Андижаннефт</span></li>
                            <li>8.ООО Ферганский Нефтеперерабатывающий Завод (ФНПЗ)</li>
                            <li>9.АО Игирнигм</li>
                            <li>10.ООО Узбекистан GTL</li>
                            <li>11.ООО Нефтгазбиноиншоат</li>
                            <li>12.У.М.Ашуров</li>
                        </ul>
                    </div>
                </div>
            </v-col>
            <v-col class="nf-vertical-left-line" lg="4" xl="4">
                <div class="">

                    <div class="pa-xl-5 pa-lg-2">
                        <p>
                            <span class="uzbekneftegaz-resolution-prent">
                                <svg height="20" width="25" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px"
                                     y="0px" viewBox="0 0 801.4 734.3" enable-background="new 0 0 801.4 734.3"
                                     xml:space="preserve">
                                     <path fill="#444444"
                                           d="M284.9,641.7h231.4c14.7,0,26.7-11.8,26.7-26.3c0-14.5-12-26.3-26.7-26.3H284.9    c-14.8,0-26.7,11.8-26.7,26.3C258.2,629.9,270.2,641.7,284.9,641.7z M284.9,558.7h231.4c14.7,0,26.7-11.8,26.7-26.3    c0-14.5-12-26.3-26.7-26.3H284.9c-14.8,0-26.7,11.8-26.7,26.3C258.2,546.9,270.2,558.7,284.9,558.7z M738.9,178.7h-85V26.3    c0-14.5-12-26.3-26.7-26.3H174.1c-14.8,0-26.7,11.8-26.7,26.3v152.4h-85c-34.4,0-62.3,27.6-62.3,61.5v265    c0,33.9,27.9,61.5,62.3,61.5h85v141.4c0,14.5,12,26.3,26.7,26.3h453.1c14.8,0,26.7-11.8,26.7-26.3V566.6h85    c34.4,0,62.3-27.6,62.3-61.5v-265C801.2,206.3,773.2,178.7,738.9,178.7z M200.8,52.6h399.7v126.1H200.8V52.6z M600.5,681.6H200.8    V466.1h399.7V681.6z M627.2,333.3h-68c-14.8,0-26.7-11.8-26.7-26.3c0-14.5,12-26.3,26.7-26.3h68c14.7,0,26.7,11.8,26.7,26.3    C653.9,321.5,641.9,333.3,627.2,333.3z"/>
                                </svg>
                            </span>
                        </p>
                        <p class="text-uppercase headline mt-8">Отдел исследований</p>
                    </div>
                    <v-divider></v-divider>
                    <div class="pa-5">
                        <p>X.I.Ispolnitel</p>
                    ...
                    <p class="pa-xl-5 pa-lg-2">Ўрнатилган тартибда кўриб чиқиб, ижросини таъминлаш учун.
                    </p>
                    <v-divider></v-divider>
                    <div class="pa-xl-5 pa-lg-2">
                        <p class="uzbekneftegaz-resolution-right-title">Ижро муддати</p>
                        <p class="">18.01.2020</p>

                        <p class="uzbekneftegaz-resolution-right-title mt-3">Приказ №13 от 13.01.2020</p>
                        <p class="">18.01.2020</p>
                        <p class="uzbekneftegaz-resolution-right-title mt-3">X.X.Xurshid</p>
                    </div>
                </div>
                <div class="nf-font-size">
                    Vazifa
                </div>
                <div>
                    <p class="assistend-otpravet-right-list">
                    ...
                    <v-divider></v-divider>
                    <p class="assistend-otpravet-right-list">
                        <span>Maqom</span> <span class="base-color">Ish jarayonida</span>
                    </p>
                    <v-divider></v-divider>
                </div>
                <div class="">
                    <div class="assistend-otpravet-right-blog pt-3 pb-3">
                        <span class="assistend-otpravet-right-blog-cricle">Ж</span>
                        <div class="ml-3">
                            <p>Ж.Ш.Умурзоқов</p>
                    ...
                    <div class="mt-3 mb-5">
                        ...
                        >
                            ...
                            <v-card>
                                ...
                                <v-card-text>
                                    <p class="chancellery-send-doc-paragraph mt-2">Javob bering</p>
                                    <v-textarea
                                            outlined
                                            height="111"
                                            name="input-7-4"
                                            label="Hujjatning qisqacha mazmuni"
                                            class="nf-bor-radius mt-2"
                                    ></v-textarea>
                                    <div class="">
                                        <p>Yuborish maqsadi</p>
                                        <v-btn
                                                color="#ff7d31"
                                                dark
                                                v-on="on"
                                                class="chancellery-send-doc-recipients mt-2"
                                        >
                                            Fayl qo'shish
                                        </v-btn>

                                        <div class="mt-2">
                                            <p class="nf-sime">Файлы</p>
                                            <ul class="nf-document-control-dialog-table-th">
                                                <li class="nf-sime pt-3 pr-3 pb-3 nf-bottom-line">Название</li>
                                                <li class="nf-sime pa-3 nf-bottom-line nf-vertical-left-line">Файлы</li>
                                                <li class="nf-sime pa-3 nf-bottom-line nf-vertical-left-line">Yuklab oling</li>
                                            </ul>
                                            <ul class="nf-document-control-dialog-table-th">
                                                <li class="pt-3 pr-3 pb-3">Hujjat.pdf</li>
                                                <li class="pa-3 nf-vertical-left-line">1.8 МБ</li>
                                                <li class="pa-3 nf-vertical-left-line link-color">Yuklab oling</li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <v-divider></v-divider>
                    <div class="mb-7 mt-6">
                        <div class="nf-document-right-person-name">
                            <p>Ж.Ш.Умурзоқов</p>
                            <p class="link-color nf-font-size16">Ответственный исполнитель</p>
                        </div>
                        <div>
                            <p class="mt-2 link-color nf-font-size16">06.02.2020</p>
                            <p class="mt-2">Hujjatning qisqacha mazmuni</p>
                        </div>
                        <v-layout class="mt-2 pa-2 align-center">
                            <v-flex row>
                        <span>
